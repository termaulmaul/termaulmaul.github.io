    ...
    <section id="contact" className="py-24 px-6 max-w-[1100px] mx-auto scroll-mt-12">
      <div className="flex flex-col md:flex-row gap-12 items-start justify-between">
        ...
        <div className="w-full md:w-2/3 flex flex-col gap-8">
          <p className="text-[20px] md:text-[28px] font-sans font-medium text-[#171717] leading-tight tracking-tight mb-4">
...
function ContactRow({ label, href, value }: { label: string; href: string; value: string }) {
  return (
    <a
      ...
      className="flex flex-col md:flex-row md:items-center justify-between gap-2 p-6 card-glass-light hover:bg-[#171717] hover:text-white transition-all group font-sans border border-black/10 shadow-sm group-hover:border-black"
    >

    ...
    <section id="focus" className="py-24 px-6 max-w-[1100px] mx-auto scroll-mt-12">
      <div className="flex flex-col md:flex-row gap-12 items-start justify-between">
        ...
        <div className="w-full md:w-2/3 flex flex-col gap-6">
          ...
          <div className="mt-8 p-8 card-glass border border-white/10 bg-[#1a1a1a] relative overflow-hidden flex flex-col items-center text-center justify-center min-h-[200px]">
            <p className="text-[20px] md:text-[28px] text-[#ffffff] font-sans font-medium tracking-tight">
